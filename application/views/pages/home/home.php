      ...
      <form>
        <div class="bg-white rounded-3 p-4 shadow mt-md-5 animate__animated animate__bounceIn">
          <div class="row">
            ...
            <div class="col-md-4">
              <button onclick="doSearch()" name="search" value="home" class="btn btn-primary2 w-100 p-3 text-white"><i class="fa fa-search"></i> SEARCH</button>
            </div>
          </div>
        </div>
      </form>
...
<section class="search-result py-5" id="search-result" >
  <div class="container">
    ...
    <div class="row d-flex align-items-stretch homes-container">
  ...
  <div class="container py-md-4">
    <div class="row">
      <div class="col-md-4 my-4 animate__animated animate__fadeInDown"> <i class="fa fa-procedures fa-3x text-white"></i>
        ...
        <b class="d-block mt-4">Average Settlement For Bedsore</b> <small class="text-white opacity-75 line-height1 d-block pt-3">The average nursing home has a large insurance policy which means it is likely that you will receive compensation.</small> </div>
      <div class="col-md-4 my-4 animate__animated animate__fadeInDown"> <i class="fa fa-running fa-3x text-white"></i>
        ...
        <b class="d-block mt-4">Average Settlement For Elopement</b> <small class="text-white opacity-75 line-height1 d-block pt-3">Nursing homes owe you a high duty of care. Failure to deliver is a liability to the skilled nursing facility.</small> </div>
      <div class="col-md-4 my-4 animate__animated animate__fadeInDown"> <i class="fa fa-user-injured fa-3x text-white"></i>
        ...
        <b class="d-block mt-4">Common Verdicts for Wrongful Death Lawsuits</b> <small class="text-white opacity-75 line-height1 d-block pt-3">Litigation against a nursing home is highly specialized. Hire a specialist attorney.</small> </div>
    </div>
  </div>
</section>
